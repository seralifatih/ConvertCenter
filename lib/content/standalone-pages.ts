...
export const standaloneToolPages: StandaloneToolPage[] = [
  ...
  },
  {
    ...
    keywords: ["average calculator", "mean calculator", "calculate average", "number average"],
  ...
  },
  {
    ...
    keywords: ["ratio calculator", "simplify ratio", "proportion calculator", "ratio simplifier"],
